        ...
        super.init({
            ...
            email: {
                ...
                validate: {
                    ...
                    len: { args: [2, 20], msg: "O email deve ter entre 2 e 20 caracteres!" }
                }
            },
            usuario: {
                type: DataTypes.STRING,
                validate: {
                    ...
                    len: { args: [2, 10], msg: "O Usuário deve ter entre 2 e 10 caracteres!" }
                }
            },
            senha: {
                type: DataTypes.STRING,
                validate: {
                    ...
                    len: { args: [2, 20], msg: "A Senha deve ter entre 2 e 20 caracteres!" }
                }
            }
